...
export const usePDFTrip = () => {
  ...
  const { pdf, trip, empresa, operador, tractor, caja, cliente, patios, mercancias, timbre } =
          ...
          columns: [
            ...
            },
            {
              text: [
                { text: 'FECHA \n', fontSize: 11 },
                {
                  text: `${moment(trip.value.createdAt).format('DD/MM/YYYY')} \n`,
                  fontSize: 9
                }
              ]
            }
          ...
          columns: [
            {
              ...
              table: {
                body: [
                  ...
                  [
                    {
                      text: `Ventana carga: ${moment(trip.value.ventana_carga).format(
                  ...
                  [
                    {
                      text: `Ventana entrega: ${moment(trip.value.ventana_entrega).format(
                        'DD/MM/YYYY hh:mm:ss A'
                      )}.`,
                      colSpan: 2,
                      fontSize: 10
